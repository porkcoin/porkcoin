...
int64 nChainStartTime = 1410935776;
...
const string strMessageMagic = "PorkCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PorkCoin
    bool fStrictPayToScriptHash = true; // Always active in PorkCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PorkCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2015-01-01 PorkCoin Lives!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("dc4b40831e26b41580279805ee4f5fcbe47180464350cd82483980c82696a267"));
...
>>>>>>> 940f2a684e617ebc445ad675dbf7d68ef4a7b248
    {
        int64 nSubsidy = 1 * COIN;
