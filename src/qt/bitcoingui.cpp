...
void BitcoinGUI::createActions()
{
 ...
 // overviewAction->setIconSize
  ...
  //  porkMarketAction = new QAction(tr("&PorkMarket"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PorkCoin"), this);
    aboutAction->setToolTip(tr("Show information about PorkCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PorkCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PorkCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PorkCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PorkCoin network", "", count));
}
...
void BitcoinGUI::gotoPorkMarketPage()
{
    porkMarketAction->setChecked(true);
    centralWidget->setCurrentWidget(porkmarketPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PorkCoin address or malformed URI parameters."));
    }
